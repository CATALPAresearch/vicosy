...
export const SET_ACT_INSTRUCTION= "SET_ACT_INSTRUCTION";
export const UNSET_ACT_INSTRUCTION= "UNSET_ACT_INSTRUCTION";
export const NEXT_INSTRUCTION= "NEXT_INSTRUCTION";
export const SET_PHASE_INSTRUCTIONS="SET_PHASE_INSTRUCTIONS";
export const PREVIOUS_INSTRUCTION="PREVIOUS_INSTRUCTION";
export const UPDATE_CONTINUEBUTTON= "UPDATE_CONTINUEBUTTON";
export const NEW_INSTRUCTION="NEW_INSTRUCTION";
export const SET_INCOMING_INSTRUCTION="SET_INCOMING_INSTRUCTION";
export const UPDATE_ACT_INSTRUCTION="UPDATE_ACT_INSTRUCTION";


//docs
export const SET_INDIV_TEXT="SET_INDIV_TEXT";
export const SET_COLLAB_TEXT="SET_COLLAB_TEXT";
export const UDPATE_COLLAB_TEXT="UDPATE_COLLAB_TEXT";
